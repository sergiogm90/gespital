...
-->
    ...
    <html>
        ...
        <div id="menu">
            ...
            <div>
                <form action="index.php?pagina=eliminacion" method="post">
                    <h1>GESTION DE LA BASE DE DATOS DE USUARIOS. ELIMINAR</h1>
                    {{errores}}
                    <div>
                    ...
                    <br>
                    <div>
                        <button type="submit" name="eliminacion">Eliminar </i></button>
                    </div>
                </form>
            </div>
        </body>
